...
<body>
        ...
        <div class="container nav-container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="../admin-quotes.php?action=logout" class="btn btn-secondary"><i class="fa-solid fa-right-from-bracket"></i> Logout</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <div class="admin-wrapper">
        ...
        <div class="dashboard-grid">
            ...
            <a href="../admin-quotes.php" class="dash-card">
